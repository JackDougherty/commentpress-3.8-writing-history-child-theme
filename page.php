...
<div class="post<?php echo commentpress_get_post_css_override( get_the_ID() ); ?>" id="post-<?php the_ID(); ?>">
	...
	<!--Subheading (long title) and Custom-Author-Byline div and Other-Version custom fields added by Jack Dougherty for WritingHistory-->
   		<?php if (function_exists('the_subheading')) { the_subheading('<h3>', '</h3>'); } ?>
         <h4><div class="entry-author-info"> <?php the_author(); ?></div></h4>
         <h4><div class="other-version-info"> <?php echo get_post_meta( $post->ID, 'other-version1', true); ?></div></h4>
		 <h4><div class="other-version-info"> <?php echo get_post_meta( $post->ID, 'other-version2', true); ?></div></h4>
